...
export default function AdminTemplatesPage() {
  ...
  const [matter, setMatter] = useState("General PI");
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-[color:var(--muted)]">Map friendly names to Adobe library document IDs or workflow IDs.</p>
      </div>
