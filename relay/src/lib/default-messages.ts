...
export const DEFAULT_SMS_EN =
  "Hi {{first_name}}, this is Ramos James Law. Please review and sign your documents here: {{signing_link}}. Reply STOP to opt out.";

export const DEFAULT_SMS_ES =
  "Hola {{first_name}}, somos Ramos James Law. Puede revisar y firmar sus documentos aquí: {{signing_link}}. Responda STOP para dejar de recibir mensajes.";
