    ...
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4">
      <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--card)] p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm text-slate-600">
          Sign in with Google using <strong>Firebase Authentication</strong> (same Google account; tokens are verified on
          the server).
        </p>
        ...
        <div className="mt-6">
          ...
          >
            ...
            {busy ? "Signing in…" : "Continue with Google (Firebase)"}
          </button>
        </div>
      </div>
    </div>
